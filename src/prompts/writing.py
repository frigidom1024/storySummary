...
## 写作风格要求
- 口语化，像在跟朋友聊天
- 基于原文内容讲述情节，节点索引只用于快速定位，不要围绕节点展开
- 从原文提取生动细节作为"聊"的素材，但不要大段朗读原文
- 适当使用口头禅（如"是吧"、"怎么说呢"、"你像"）
- 每个章节要有自然的过渡句，承接上文引出下文

## 重要提醒
- 节点（nodes_summary）只是索引，让你快速知道这一章有哪些关键场景
- 实际讲述内容必须来自【本章完整原文】，用自己的话复述和解读
- 不要列出节点然后一个个讲解，要像朋友聊天一样自然地串联情节
